        ...
        <div className="modal" onClick={() => { props.hideHowTo() }}>
            <div id="howToModal" className="modal-content" onClick={(event) => {event.stopPropagation()}}>
                ...
                <div className="howToBottom space">
                    ...
                    <div className="space ">The object of Battleship is to sink all of the Computer's ships before they sink all of your ships.</div>
                    ...
                    <div className="">
                        ...
                        <div className="">Individually place each of your ships somewhere on the board. Or select "Auto Place" to have all of your ships randomly placed on your board. Then select the "Start" button to begin the game.</div>
                    <div className="space  list"><strong>2. Player Turn:</strong></div>
                    <div className="">Select a square on the Computer's board to attack. If the attack hits one of the Computer's ships, the square will turn red. If the attack misses the Computer's ships, the square will turn white.</div>
                    <div className="space  list"><strong>3. Computer Turn:</strong></div>
                        <div className="">The computer will select a square on your board to attack. If the attack hits one of your ships, the square will turn red. If the attack misses your ships, the square will turn white.</div>
