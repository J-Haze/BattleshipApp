    ...
    if (props.orient == "horizontal") {
        return (
            <div id={props.id} className="fleet-horizontal" >
                ...
                <div className={`battleship-horizontal ${carrierClickable} ship-harbor-horizontal${toggledBattleship}`} onClick={() => props.togglePlacement("battleship")}>
                    <div className={battleshipClass}></div>
                    <div className={battleshipClass}></div>
                    <div className={battleshipClass}></div>
                    <div className={battleshipClass}></div>
                </div>
                <div className={`cruiser-horizontal ${carrierClickable} ship-harbor-horizontal${toggledCruiser}`} onClick={() => props.togglePlacement("cruiser")}>
                    <div className={cruiserClass}></div>
                    <div className={cruiserClass}></div>
                    <div className={cruiserClass}></div>
                </div>
                <div className={`submarine-horizontal ${carrierClickable} ship-harbor-horizontal${toggledSubmarine}`} onClick={() => props.togglePlacement("submarine")}>
                    <div className={submarineClass}></div>
                    <div className={submarineClass}></div>
                    <div className={submarineClass}></div>
                </div>
                <div className={`destroyer-horizontal ${carrierClickable} clickable ship-harbor-horizontal${toggledDestroyer}`} onClick={() => props.togglePlacement("destroyer")}>
