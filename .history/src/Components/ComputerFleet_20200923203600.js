...
function ComputerFleet(props) {
    ...
    return (
        <div id={props.id} className="fleet" >
            <div className={`carrier-horizontal ship-harbor-horizontal${sunkCarrier}`} ></div>
            <div className={`battleship-horizontal ship-harbor-horizontal${sunkBattleship}`} ></div>
            <div className={`cruiser-horizontal ship-harbor-horizontal${sunkCruiser}`} ></div>
            <div className={`submarine-horizontal ship-harbor-horizontal${sunkSubmarine}`} ></div>
            <div className={`destroyer-horizontal ship-harbor-horizontal${sunkDestroyer}`} ></div>
        </div >
    )
