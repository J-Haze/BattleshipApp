...
function Game() {
    ...
    const placeShipsPlayer = (pCarrier, pBattleship, pCruiser, pSubmarine, pDestroyer, pCarrierOrient, pBattleshipOrient, pCruiserOrient, pSubmarineOrient, pDestroyerOrient) => {
        ...
        player.gameboard.placeShip(carrier, 5, pCarrier, pCarrierOrient);
    ...
    function handleClick(id) {
        ...
        attackCoord = player.sendAttack(id);
        ...
        setComputerBoard(computer.gameboard.receiveAttack(attackCoord))
