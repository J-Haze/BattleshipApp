    ...
    if (props.orient == "horizontal") {
        return (
            <div id={props.id} className="fleet-horizontal" >
                <div className={`carrier-horizontal clickable ship-harbor-horizontal${toggledCarrier}`} onClick={() => props.togglePlacement("carrier")}>
                ...
                <div className={`battleship-horizontal clickable ship-harbor-horizontal${toggledBattleship}`} onClick={() => props.togglePlacement("battleship")}>
                    <div className={battleshipClass}></div>
                    <div className={battleshipClass}></div>
                    <div className={battleshipClass}></div>
                    <div className={battleshipClass}></div>
                </div>
                <div className={`cruiser-horizontal clickable ship-harbor-horizontal${toggledCruiser}`} onClick={() => props.togglePlacement("cruiser")}>
                    <div className={cruiserClass}></div>
                    <div className={cruiserClass}></div>
                    <div className={cruiserClass}></div>
                </div>
                <div className={`submarine-horizontal clickable ship-harbor-horizontal${toggledSubmarine}`} onClick={() => props.togglePlacement("submarine")}>
                    <div className={submarineClass}></div>
                    <div className={submarineClass}></div>
                    <div className={submarineClass}></div>
                </div>
                <div className={`destroyer-horizontal clickable ship-harbor-horizontal${toggledDestroyer}`} onClick={() => props.togglePlacement("destroyer")}>
        ...
        return (
            <div id={props.id} className="fleet-vertical" >
                <div className={`carrier-vertical clickable ship-harbor-vertical${toggledCarrier}`} onClick={() => props.togglePlacement("carrier")} >
                    <div className={carrierClass}></div>
                    <div className={carrierClass}></div>
                    <div className={carrierClass}></div>
                    <div className={carrierClass}></div>
                ...
                <div className={`battleship-vertical clickable ship-harbor-vertical${toggledBattleship}`} onClick={() => props.togglePlacement("battleship")} >
                    <div className={battleshipClass}></div>
                    <div className={battleshipClass}></div>
                    <div className={battleshipClass}></div>
                    <div className={battleshipClass}></div>
                </div>
                <div className={`cruiser-vertical clickable ship-harbor-vertical${toggledCruiser}`} onClick={() => props.togglePlacement("cruiser")} >
                    <div className={cruiserClass}></div>
                    <div className={cruiserClass}></div>
                    <div className={cruiserClass}></div>
                </div>
                <div className={`submarine-vertical clickable ship-harbor-vertical${toggledSubmarine}`} onClick={() => props.togglePlacement("submarine")} >
                    <div className={submarineClass}></div>
                    <div className={submarineClass}></div>
                    <div className={submarineClass}></div>
                </div>
                <div className={`destroyer-vertical clickable ship-harbor-vertical${toggledDestroyer}`} onClick={() => props.togglePlacement("destroyer")} >
                    <div className={destroyerClass}></div>
                    <div className={destroyerClass}></div>
                </div>
            </div >
