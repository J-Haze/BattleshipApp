    ...
    if (props.orient == "horizontal") {
        ...
        return (
            <div id={props.id} className="fleet" > Error
                <div className="carrier ship-harbor vertical" ></div>
                <div className="battleship ship-harbor vertical"></div>
                <div className="cruiser ship-harbor vertical"></div>
                <div className="submarine ship-harbor vertical"></div>
                <div className="destroyer ship-harbor vertical"></div>
            </div >
        )
    }
