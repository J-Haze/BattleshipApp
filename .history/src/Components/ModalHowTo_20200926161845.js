        ...
        <div className="modal">
            <div id="howToModal" className="modal-content">
                ...
                <div className="howToBottom">
                    ...
                    <div>Select a square on the Computer's board to attack. If the attack hits one of the Computer's ships, the square will turn red. If the attack misses the Computer's ships, the square will turn blue. When a ship is sunk, the ship in the player's fleet will fade.</div>
