...
function Game() {
    ...
    function handlePlaceShip(id) {
        playerState.gameboard.placeShip(placingShip, 5, id, orientation)
    }
            ...
            <div id="top-row">
                <div id="setup">
                    ...
                    <div id="setup-buttons">
                        <div id="rotate" class="btn" onClick={() => rotateShips()}>Rotate</div>
                        <div id="auto-place" class="btn">Auto Place</div>
