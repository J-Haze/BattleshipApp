...
function Game() {
    ...
    //     console.log("pBoard UseEffect:", pBoard)
    //     console.log("playerBoard UseEffect:", playerBoard)
    // },
    //     [pBoard]
    // );
    ...
    setPlayerBoard(placeShipsPlayer(pCarrier, pBattleship, pCruiser, pSubmarine, pDestroyer, pCarrierOrient, pBattleshipOrient, pCruiserOrient, pSubmarineOrient, pDestroyerOrient));

    // console.log({ playerBoard });
    // setPlayerBoard(playerOne.gameboard.placeShip(carrier, 5, pCarrier, pCarrierOrient))
    // setPlayerBoard(playerOne.gameboard.placeShip(battleship, 4, pBattleship, pBattleshipOrient))
    // setPlayerBoard(playerOne.gameboard.placeShip(cruiser, 3, pCruiser, pCruiserOrient))
    // setPlayerBoard(playerOne.gameboard.placeShip(submarine, 3, pSubmarine, pSubmarineOrient))
    // setPlayerBoard(playerOne.gameboard.placeShip(destroyer, 2, pDestroyer, pDestroyerOrient))
