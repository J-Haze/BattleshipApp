...
const gameboardFactory = () => {
    ...
    const receiveAttack = (x, y) => {
        ...
        if (attackID[0] == false) {
            ...
            boatHit.isSunk() ? console.log(`Player's ${boatHitString} is sunk!`) : console.log("Not sunk")
...
gameboard_1.placeShip(cruiser, 3, 82, "horizontal");

gameboard_1.placeShip(destroyer, 2, 6, "horizontal");
